...
import { splineEmptyData } from './spline-empty-data'; // Assuming you have a data source file
        ...
        <div>
            ...
            <Chart theme={chartTheme}>
                ...
                <ChartSeriesCollection>
                    <ChartSeries dataSource={splineEmptyData} xField="x" yField="y" width={2} type="Spline" fill={"#009698"} emptyPointSettings={{ mode: emptyPointMode }}>
