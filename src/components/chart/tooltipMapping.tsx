import { Chart, ChartPrimaryXAxis, ChartPrimaryYAxis, ChartSeries, ChartSeriesCollection, ChartTooltip, ChartTitle, ChartMarker, ChartDataLabel, ChartArea, ChartAxisTitle, ChartStripLines, ChartStripLine, ChartAxisLabel } from '@syncfusion/react-charts'
    ...
    return (
        <Chart theme={chartTheme}>
            ...
            <ChartSeriesCollection>
                <ChartSeries dataSource={bubbleData} type='Bubble' minRadius={3} maxRadius={6} tooltipField='toolTipMappingName' xField='x' yField='y' sizeField='size' opacity={0.6} colorField='tooltipColor'>
                    <ChartMarker border={{ width: 2 }}>
