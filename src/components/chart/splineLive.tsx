...
import {
    Chart, ChartPrimaryXAxis, ChartPrimaryYAxis, ChartSeries, ChartSeriesCollection, ChartTitle, ChartComponentProps, ChartMarker, ChartAxisLabel,
    ChartMajorGridLines
...
export default function App() {
    ...
    return (
        <Chart ref={chartRef} theme={chartTheme}>
            ...
            <ChartPrimaryXAxis valueType={'DateTime'} interval={1} intervalType="Minutes">
                <ChartAxisLabel rotationAngle={Browser.isDevice ? -45 : 0} />
                <ChartMajorGridLines width={1} />
            </ChartPrimaryXAxis>
            <ChartPrimaryYAxis valueType={'Double'} maximum={70}>
                <ChartMajorGridLines width={1} />
            </ChartPrimaryYAxis>
            <ChartSeriesCollection>
                <ChartSeries dataSource={dataSource} xField="x" yField="y" type="Spline" fill="#E377C2" animation={{ enable: true, duration: 500 }}>
