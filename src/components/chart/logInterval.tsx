...
export default function App() {
    ...
    return (
        <Chart theme={chartTheme}>
            ...
            <ChartPrimaryYAxis valueType="Logarithmic" lineStyle={{ width: 0 }} minimum={0} maximum={100000} interval={2}>
                <ChartMajorGridLines width={1.5} />
                <ChartAxisLabel format="${value}" />
            </ChartPrimaryYAxis>
            <ChartSeriesCollection>
                <ChartSeries dataSource={logAxisData} xField="x" yField="y" type="Line" width={2} fill="#FF8040">
