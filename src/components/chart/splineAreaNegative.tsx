    ...
    return (
        <Chart theme={chartTheme}>
            ...
            <ChartSeriesCollection>
                <ChartSeries dataSource={lineNegativeData} xField="x" yField="USD" width={2} type="SplineArea" opacity={0.4} fill="#D6FF89" border={{ width: 2, color: chartTheme.includes('Dark') ? "#A3E920" : "#71AD01" }} />
            </ChartSeriesCollection>
