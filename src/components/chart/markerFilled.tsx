    ...
    return (
        <Chart theme={chartTheme}>
            ...
            <ChartSeriesCollection>
                <ChartSeries dataSource={markerOverviewData} xField='year' yField='China' name="China" fill="#BA7DDA" width={2} type='Spline'>
                    <ChartMarker visible={true} filled={false}/>
                </ChartSeries>
                <ChartSeries dataSource={markerOverviewData} xField='year' yField='United States' name="United States" fill="#00C5BC" width={2} type='Spline'>
                    <ChartMarker visible={true} filled={false}/>
                </ChartSeries>
            </ChartSeriesCollection>
        </Chart>
