import { Chart, ChartPrimaryXAxis, ChartPrimaryYAxis, ChartSeries, ChartSeriesCollection, ChartTooltip, ChartAxisTitle, ChartAxisLabel, ChartTitle, ChartMarker, ChartStackLabels } from '@syncfusion/react-charts'
...
export default function App() {
    ...
    return (
        <Chart theme={chartTheme}>
            ...
            <ChartStackLabels visible={true} rotationAngle={0}></ChartStackLabels>
