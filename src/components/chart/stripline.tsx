    ...
    return (
        <Chart theme={chartTheme}>
            ...
            <ChartPrimaryYAxis minimum={0} maximum={30} interval={10} lineStyle={{ width: 0 }} rangePadding='None'>
                ...
                <ChartStripLines>
                    <ChartStripLine range={{ start:0, end: 5 }} text={{ content: 'Calm', hAlign: 'Left', font: { fontSize: '13px' } }} style={{ color: 'rgba(68, 170, 213, 0.1)', border: { width: 0 } }} visible={true} />
                    <ChartStripLine range={{ start:5, end: 8 }} text={{ content: 'Light Air', hAlign: 'Left', font: { fontSize: '13px' } }} style={{ color: 'rgba(0, 0, 0, 0)', border: { width: 0 } }} visible={true} />
                    <ChartStripLine range={{ start:8, end: 11 }} text={{ content: 'Light Breeze', hAlign: 'Left', font: { fontSize: '13px' } }} style={{ color: 'rgba(68, 170, 213, 0.1)', border: { width: 0 } }} visible={true} />
                    <ChartStripLine range={{ start:11, end: 18 }} text={{ content: 'Gentle Breeze', hAlign: 'Left', font: { fontSize: '13px' } }} style={{ color: 'rgba(0, 0, 0, 0)', border: { width: 0 } }} visible={true} />
                    <ChartStripLine range={{ start:18, end: 28 }} text={{ content: 'Moderate Breeze', hAlign: 'Left', font: { fontSize: '13px' } }} style={{ color: 'rgba(68, 170, 213, 0.1)', border: { width: 0 } }} visible={true} />
                    <ChartStripLine range={{ start:28, end: 30 }} text={{ content: 'Fresh Breeze', hAlign: 'Left', font: { fontSize: '13px' } }} style={{ color: 'rgba(0, 0, 0, 0)', border: { width: 0 } }} visible={true} />
                </ChartStripLines>
            </ChartPrimaryYAxis>
