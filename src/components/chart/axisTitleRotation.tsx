    ...
    return (
        <Chart theme={chartTheme}>
            ...
            <ChartPrimaryYAxis lineStyle={{ width: 0 }}>
                <ChartAxisTitle text="Population in Billion" rotationAngle={0} color="#7142FF" fontFamily="Segoe UI" fontWeight="bold" />
                <ChartAxisLabel format='{value}B' />
            </ChartPrimaryYAxis>
            <ChartSeriesCollection>
                <ChartSeries dataSource={smartAxisLabelData} xField="x" yField="y" type="Column" fill='#009B77' columnWidth={0.4} cornerRadius={{ topLeft: 5, topRight: 5 }} />
            </ChartSeriesCollection>
        </Chart>
    );
}