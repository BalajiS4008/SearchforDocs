import { Chart, ChartPrimaryXAxis, ChartPrimaryYAxis, ChartSeries, ChartSeriesCollection, ChartTooltip, ChartTitle, ChartMarker, ChartDataLabel, ChartStripLines, ChartStripLine, ChartAxisTitle, ChartArea, ChartAxisLabel } from '@syncfusion/react-charts'
    ...
    return (
        <Chart theme={chartTheme}>
            ...
            <ChartSeriesCollection>
                <ChartSeries dataSource={bubbleData} type='Bubble' minRadius={3} maxRadius={6} tooltipField='toolTipMappingName' border={{ width: 2 }} xField='x' yField='y' sizeField='size' opacity={0.5}>
                    <ChartMarker>
                        <ChartDataLabel visible={true} position='Middle' />
                    </ChartMarker>
                </ChartSeries>
            </ChartSeriesCollection>
        </Chart>
