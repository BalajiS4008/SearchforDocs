import { Chart, ChartPrimaryXAxis, ChartPrimaryYAxis, ChartSeries, ChartSeriesCollection, ChartAxisTitle, ChartTooltip, ChartTitle } from "@syncfusion/react-charts"
    ...
    return (
        <Chart theme={chartTheme}>
            ...
            <ChartSeriesCollection>
                <ChartSeries dataSource={stepLineData} xField="x" yField="y" width={3} step="Center" type="StepLine" noRisers={true} fill={"#0FAF9C"} />
            </ChartSeriesCollection>
        </Chart>
    );
}