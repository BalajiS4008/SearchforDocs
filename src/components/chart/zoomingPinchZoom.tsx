import { Chart, ChartPrimaryXAxis, ChartPrimaryYAxis, ChartSeriesCollection, ChartSeries, ChartZoomSettings, ChartAxisTitle, ChartTitle, ChartAxisLabel } from "@syncfusion/react-charts";
...
export default function App() {
    ...
    return (
        <Chart theme={chartTheme}>
            ...
            <ChartZoomSettings pinchZoom={true} mode='X' />
