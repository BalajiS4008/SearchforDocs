    ...
    return (
        <Chart theme={chartTheme}>
            ...
            <ChartSeriesCollection>
                <ChartSeries dataSource={splineAreaData} xField="x" yField="y1" type="SplineArea" opacity={0.4} fill="#D6FF89" width={2} border={{ width: 2, color: chartTheme.includes('Dark') ? "#A3E920" : "#71AD01", dashArray:'5,5'}}>
                </ChartSeries>
            </ChartSeriesCollection>
        </Chart>
    );
