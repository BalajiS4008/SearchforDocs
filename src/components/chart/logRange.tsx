...
export default function App() {
    ...
    return (
        <Chart theme={chartTheme}>
            ...
            <ChartPrimaryYAxis valueType="Logarithmic" lineStyle={{ width: 0 }} minimum={100} maximum={100000}>
                <ChartMajorGridLines width={1.5} />
                <ChartAxisLabel format="${value}" />
            </ChartPrimaryYAxis>
            <ChartSeriesCollection>
                <ChartSeries dataSource={logRangeData} xField="x" yField="y" type="Line" width={2} fill="#ED3500">
