import { Chart, ChartPrimaryXAxis, ChartPrimaryYAxis, ChartSeries, ChartSeriesCollection, ChartTooltip, ChartTitle, ChartMarker, ChartDataLabel, ChartArea, ChartAxisTitle, ChartStripLine, ChartStripLines } from '@syncfusion/react-charts'
    ...
    return (
        <Chart theme={chartTheme}>
            ...
            <ChartSeriesCollection>
                <ChartSeries dataSource={bubbleData} type='Bubble' minRadius={3} maxRadius={6} tooltipField='toolTipMappingName' border={{ width: 2 }} xField='x' yField='y' sizeField='size' opacity={0.7}>
                    <ChartMarker>
