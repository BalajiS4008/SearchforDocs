...
import { Chart, ChartPrimaryXAxis, ChartPrimaryYAxis, ChartSeries, ChartSeriesCollection, ChartTitle, ChartComponentProps, ChartMarker, ChartAxisLabel
...
export default function App() {
    ...
    return (
        <Chart ref={chartRef} theme={chartTheme}>
            <ChartTitle text={'Live Area Chart'} />
            ...
            <ChartSeriesCollection>
                <ChartSeries dataSource={dataSource} xField="x" yField="y" type="Area" opacity={0.4} fill="#3CFFD2" border={{ width: 2, color: chartTheme.indexOf('Dark') > -1 ? "#3CFFD2" : '#008264' }} animation={{ enable: true, duration: 500 }}>
                    <ChartMarker visible={true} fill={chartTheme.indexOf('Dark') > -1 ? "#3CFFD2" : "#008264"} border={{ width: 2, color: chartTheme.indexOf('Dark') > -1 ? "#3CFFD2" : '#008264'}}></ChartMarker>
                </ChartSeries>
            </ChartSeriesCollection>
        </Chart>
    );
