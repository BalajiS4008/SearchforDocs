...
export default function App() {
    ...
    return (
        <Chart theme={chartTheme}>
            ...
            <ChartPrimaryYAxis lineStyle={{ width: 0 }} opposedPosition={true} interval={0.3}>
                <ChartAxisLabel format='{value}B' />
            </ChartPrimaryYAxis>
            <ChartSeriesCollection>
                <ChartSeries dataSource={smartAxisLabelData} xField="x" yField="y" type="Column" fill='#E26EE5E5' columnWidth={0.4} cornerRadius={{ topLeft: 5, topRight: 5 }} />
            </ChartSeriesCollection>
        </Chart>
    )
}