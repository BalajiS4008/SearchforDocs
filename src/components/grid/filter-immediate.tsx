import { Grid, Column, Columns, FilterSettings, SortSettings, PageSettings, FilterBarType, TextAlign, FilterBarMode, ColumnType } from '@syncfusion/react-grid';
...
export default function App() {
    ...
    // State to enable filtering with immediate mode and delay.
    const [filterSettings] = useState<FilterSettings>({ enabled: true, mode: FilterBarMode.Immediate, type: 'FilterBar', immediateModeDelay: 2000 }); 
