...
export const formValidatorNpm: SnippetItem[] = [
  { title: "NPM", code: 'npm install @syncfusion/react-inputs' }
];

export const formValidatorStyles: SnippetItem[] = [
  {
    title: "App.css",
...
export const formValidatorImport: SnippetItem[] = [
  {
    title: "App.tsx",
    code: `import { Form, FormField } from '@syncfusion/react-inputs';`
  }
];

export const formValidatorSnippet: SnippetItem[] = [
  {
    title: "App.tsx",
